var intro = {
    ...
    "title": "Welcome!",
    // introduction text
    "text": "Thank you for participating in our study. In this study, you will see pictures about cats and click on buttons referring your opinion about each of them.",
...
var instructions = {
    ...
    "title": "Instructions",
    // instruction's text
    "text": "On each trial, you will see a question and three response options. Please select the response option you like most. We start with three practice trials.",
...
var practice = {
    ...
    render: function (CT) {
		...
		option3: exp.trial_info.practice_trials[CT].option3,
